...
class RaspiControl:
    ...
    def enviar_correo(self, correo_origen, contraseña, correo_destino, asunto, mensaje):
        try:
...
# ---------------------------------------------------LECTURA DE DATOS -------------------------------
        ...
        distancia = raspi.leer_distancia()
        ...
        infonum = int(info[0])
        if infonum == 0 and flag == 0:
            print("mensajede alerta enviado")
            raspi.enviar_correo('michaelsilver1674@gmail.com',
                                'slqw icih ingc djha',
                                'nayara.lara@ucb.edu.bo',
                                'EMERGENCIA',
                                'EL sistema de seguridad se ha desactivado')
            flag = 1
            break
